  ...
  return (
    ...
    >
      <Box
        sx={{
          width: '100%',
          maxWidth: 766, // Maximum width from original
          minHeight: { xs: 'auto', md: 324 }, // Flexible height on mobile
          bgcolor: '#FFFFFF',
          borderRadius: '8px',
          p: { xs: '16px', sm: '24px' }, // Responsive padding
          boxShadow: 6,
          position: 'relative',
          overflow: 'hidden',
          display: 'flex',
      ...
      >
        {/* Header row */}
        <Box sx={{ display: 'flex', alignItems: 'center', width: '100%', gap: '12px', mb: '12px' }}>
        ...
        {/* Divider line */}
        <Box sx={{ width: '100%', height: '1px', bgcolor: '#000048', border: '1px solid #000048' }} />
        ...
        <Box sx={{
          ...
          <Box sx={{ width: 64, height: 92, mb: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {deviceStatus.available ? (
              <Box
                ...
                sx={{
                  ...
                  '&:active': { transform: 'scale(0.95)' }, // Visual feedback
              ...
              >
                ...
                <Box sx={{ position: 'absolute', width: 64, height: 92, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Box sx={{
                    position: 'absolute', width: 64, height: 64, borderRadius: '50%', border: '3px solid rgba(38,239,233,0.18)',
                    '@keyframes ripple': { '0%': { transform: 'scale(0.8)', opacity: 1 }, '100%': { transform: 'scale(1.5)', opacity: 0 } },
                    animation: 'ripple 2000ms infinite'
                  }} />
                  <Box sx={{
                    position: 'absolute', width: 48, height: 48, borderRadius: '50%', border: '2px solid rgba(43,180,215,0.22)',
                    animation: 'ripple 1800ms infinite', animationDelay: '220ms'
                  }} />
                </Box>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 1 }}>
                <Typography sx={{ fontFamily: 'Poppins, sans-serif', fontWeight: 400, fontSize: '15px', lineHeight: '22px', color: '#000048', textAlign: 'center' }}>
                  {deviceStatus.message}
                </Typography>
                <Button variant="contained" onClick={() => onExit && onExit()} sx={{ mt: 1, bgcolor: '#000048', color: '#fff', '&:hover': { bgcolor: '#000030' } }}>
                  Exit
                </Button>
              </Box>
            )}
