        ...
        >
          ...
          >
            ...
            <Box
              ...
              src={`${process.env.PUBLIC_URL}/logo/Boy.png`}
...
// Fix: supports DB repo paths like invisiblepayments_frontend-Dec05\frontend\public\logo\Grapes.png

const getImageUrl = (path) => {
  if (!path) return "/logo/16.png";
 
  // Get the filename only (e.g., 'Bananas.png')
  ...
  return `${process.env.PUBLIC_URL}/logo/${cleanFileName}`;
};
...
const ShoppingHandheld = ({
  ...
  const additionalRequired =
    ...
    orderTotal > walletBalance ? (orderTotal - walletBalance).toFixed(2) : "0.00";
  ...
  if (!isLoading && cart.length === 0 && !isProcessing && !showPaymentSuccess && !paymentError) {
    ...
    return <EmptyCartView user={user} onLogout={onLogout} />;
    ...
    <Box sx={{ bgcolor: "#FFFFFF", minHeight: "100vh", width: "100%" }}>
      ...
      >
        ...
        >
          ...
          {error && (
            ...
            <Alert severity="error" sx={{ mb: 2, fontFamily: "Gallix, sans-serif" }}>
          ...
          <Box sx={{ display: { xs: "none", md: "flex" }, px: 2, alignItems: "center" }}>
          ...
          <Box sx={{ mt: "auto" }}>
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={{ fontSize: "12px", color: "#000048", opacity: 0.7 }}>

                  Total Amount

                </Typography>

                <Typography sx={{ fontWeight: 700, fontSize: "18px", color: "#000048" }}>
      ...
      >
        ...
        <DialogContent sx={{ p: 0 }}>
          ...
          <Box sx={{ display: "flex", gap: { xs: "16px", md: "32px" }, justifyContent: "center", flexWrap:"wrap" }}>
            ...
            <Button onClick={handleConfirmAndOpenPayment} variant="contained" sx={containedButtonStyle}>
      ...
      >
        ...
        <DialogContent sx={{ p: { xs: "12px 16px 24px", md: "12px 24px 42px 24px" } }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "24px", py: 3 }}>
      ...
      >
        ...
        <DialogContent sx={{ p: { xs: "12px 16px", md: "12px 24px 24px 24px" } }}>
          ...
          <Box sx={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <Typography sx={{ fontFamily: "Gallix, sans-serif", fontSize: "14px", color: "#5C5C5C" }}>

              Wallet Balance: ${walletBalance.toFixed(2)}

            </Typography>

            <Typography sx={{ fontFamily: "Gallix, sans-serif", fontSize: "14px", color: "#000048" }}>
        ...
        >
          ...
          <Box component="span" sx={{ mr: 0.75 }}>Existing user with</Box>

          <Link

            href="https://20.219.97.165.nip.io/register/"
            ...
            sx={{
              ...
              '&:hover': { color: 'rgba(47, 120, 196, 1)' },

              '&:visited': { color: 'rgba(47, 120, 196, 1)' }

            }}

          >

            low wallet?Navigate to TopUp
      ...
      >
        ...
        >
          ...
          >
            <Box
              component="img"
              src={`${process.env.PUBLIC_URL}/logo/BoyLogo.png`}
              sx={{
                width: { xs: "28px", sm: "32px", md: "38px" },
                height: { xs: "28px", sm: "32px", md: "38px" },
                flexShrink: 0,
...
const getImageUrl = (path) => {
  ...
  const fallback = `${base}/logo/16.png`;
  ...
  // Extract filename from windows/repo paths
