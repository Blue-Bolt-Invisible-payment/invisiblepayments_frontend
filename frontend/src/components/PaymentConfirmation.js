...
const PaymentConfirmation = ({ user, total, onExit }) => {
  ...
  return (
    <Box sx={{ width: '100%', minHeight: '100vh', bgcolor: '#f5f5f5', display: 'flex', alignItems: 'center', justifyContent: 'center', p: 2, position: 'relative' }}>
      <Box sx={{ maxWidth: 600, width: '100%', mx: 'auto' }}>
        {processing && (
          <>
            ...
            <Box sx={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1400 }}>
              <Paper sx={{ p: 5, textAlign: 'center', borderRadius: 4, boxShadow: 5, minWidth: 360 }}>
            ...
            >
              ...
              <Box sx={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <Box sx={{ display: 'flex', alignItems: 'center', gap: '12px', height: '40px' }}>
                  ...
                  <Typography sx={{ fontFamily: 'Gallix, sans-serif', fontWeight: 500, fontSize: '24px', color: '#000048' }}>
                    Payment Successful
                  </Typography>
                </Box>

                <IconButton onClick={onExit} sx={{ width: 40, height: 40 }} aria-label="close">
              ...
              <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '24px' }}>
                <Box sx={{ width: 82, height: 82, borderRadius: '50%', bgcolor: '#2DB81F', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <CheckCircleIcon sx={{ color: '#FFFFFF', fontSize: 49 }} />
                </Box>

                <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                  <Typography sx={{ fontFamily: 'Gallix, sans-serif', fontWeight: 400, fontSize: '17px', color: '#000048', textAlign: 'center' }}>
                    Your payment has been completed.
                  </Typography>
                  <Typography sx={{ fontFamily: 'Gallix, sans-serif', fontWeight: 400, fontSize: '15px', color: '#000048', textAlign: 'center' }}>
                    A receipt has been sent to your linked email-id.
                  </Typography>
                </Box>

                <Typography sx={{ fontFamily: 'Gallix, sans-serif', fontWeight: 600, fontSize: '20px', color: '#000048', textAlign: 'center' }}>
        ...
        {error && !processing && (
          <PaymentFailed open={Boolean(error)} onClose={() => setError('')} onRetry={handlePayment} onExit={onExit} />
        )}
      </Box>
    </Box>
  );
