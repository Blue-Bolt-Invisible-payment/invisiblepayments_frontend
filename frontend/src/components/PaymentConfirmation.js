  ...
  return (
    ...
    >
      <Box sx={{ maxWidth: 600, width: "100%", mx: "auto" }}>
        {processing && (
          <Paper
            sx={{ p: 5, textAlign: "center", borderRadius: 4, boxShadow: 5 }}
          >
        ...
        {paymentSuccess && !processing && (
          <Paper
            sx={{ p: 4, textAlign: "center", borderRadius: 4, boxShadow: 6 }}
          >
            <Box sx={{ mb: 3 }}>/logo/image.png</Box>
            <CheckCircleIcon sx={{ fontSize: 90, color: "#4caf50", mb: 2 }} />
            <Typography
              variant="h4"
              sx={{ fontWeight: "bold", color: "#000048", mb: 1 }}
            >
              Success!
            </Typography>
            ...
            >
              The invoice has been sent to <strong>{displayEmail}</strong> and
              via SMS to <strong>{displayPhone}</strong>.
              <br />
              ...
              <CardContent>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  <Typography variant="h6" fontWeight="bold" color="#4caf50">
                    ₹{Number(resolvedAmount).toFixed(2)}
                  </Typography>
                </Box>
              </CardContent>
            </Card>
